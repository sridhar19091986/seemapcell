...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents SelectClauseTextBox As System.Web.UI.WebControls.TextBox
    Protected WithEvents DataBaseLabel As System.Web.UI.WebControls.Label
    Protected WithEvents OpenTableTextBox As System.Web.UI.WebControls.TextBox
    Protected WithEvents Label2 As System.Web.UI.WebControls.Label
    Protected WithEvents OpenTableButton As System.Web.UI.WebControls.Button
    Protected WithEvents Repeater1 As System.Web.UI.WebControls.Repeater
    Protected WithEvents Panel1 As System.Web.UI.WebControls.Panel
    Protected WithEvents Label3 As System.Web.UI.WebControls.Label
    Protected WithEvents WarningLabel As System.Web.UI.WebControls.Label
...
#End Region
    ...
    Private Sub InitState()
        ...
        If Application.Get("DataAccessWeb") Is Nothing Then
            ...
            If (MapInfo.Engine.Session.Current.Catalog.NamedConnections.Count = 0) Then
                Dim path As String = HttpContext.Current.Server.MapPath(String.Format("/DataAccessWebVB_{0}_{1}", MapInfo.Engine.ProductInfo.MajorVersion, MapInfo.Engine.ProductInfo.MinorVersion))
    ...
    Private Sub SetDataGrid(ByVal dataGrid As DataGrid, ByVal commandText As String, ByVal bShowSchema As Boolean)
        ...
        Catch exception1 As Exception
            Me.SelectClauseTextBox.Text = (Me.SelectClauseTextBox.Text & " ***The select clause is either is not specified or is incorrect. Please enter it again.***")
        Finally
    ...
    Private Sub OpenTableButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OpenTableButton.Click
        If (Me.CheckBoxList1.SelectedValue Is Nothing Or Me.CheckBoxList1.SelectedValue.Length = 0) Then Return
        WarningLabel.Visible = False
