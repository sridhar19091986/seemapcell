...
namespace HelloWorldWeb
{
	...
	public class WebForm1 : System.Web.UI.Page
	{
		...
		protected MapInfo.WebControls.LayerControl LayerControl1;
		...
		private void AddNorthArrowAdornment(Map myMap)
		{
			...
			{
				string path = HttpContext.Current.Server.MapPath(string.Format("/MapXtremeWebResources {0}_{1}", MapInfo.Engine.ProductInfo.MajorVersion, MapInfo.Engine.ProductInfo.MinorVersion));
