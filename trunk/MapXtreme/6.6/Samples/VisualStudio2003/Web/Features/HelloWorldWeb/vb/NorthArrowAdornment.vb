...
Public NotInheritable Class NorthArrowAdornment
    ...
    Friend Sub New(ByVal adornmentAlias As String, ByVal mapAlias As String)
        Me._alias = adornmentAlias
        Me._mapAlias = mapAlias
    End Sub
...
#End Region
    ...
    Friend Sub SetObjectData(ByVal info As SerializationInfo, ByVal context As StreamingContext)
...
' </remarks>
<Serializable()> _
Friend NotInheritable Class NorthArrowAdornmentDeserializer
