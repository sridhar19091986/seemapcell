...
namespace HelloWorldWeb
{
	...
	public sealed class NorthArrowAdornment : MapInfo.Mapping.IAdornment, ISerializable
	{
		...
		internal NorthArrowAdornment(string adornmentAlias, string mapAlias)
		{
			_alias = adornmentAlias;
			_mapAlias = mapAlias;
		}
	...
	/// </remarks>
	[Serializable]
	internal sealed class NorthArrowAdornmentDeserializer : IObjectReference, ISerializable
	{
